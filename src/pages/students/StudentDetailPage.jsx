...
import { formatSlotDate, formatSlotTime, formatVideoDuration } from '../../utils/formatSlotTime.js'
...
import { RecordTabs, RecordTabPanel } from '@/components/records/RecordTabs'
import {
  GlassPanel,
  RecordGroup,
  RecordEntry,
  ...
  groupByBand,
  groupByMonth,
} from '@/components/records/RecordTimeline'
        ...
        <PageContainer className="p-0">
          ...
          <div className="flex flex-col">
            ...
            <GlassPanel>
              ...
              <RecordTabPanel baseId={panelBaseId} id="bookings" activeId={tab}>
              ...
              <RecordTabPanel baseId={panelBaseId} id="courses" activeId={tab}>
              ...
              <RecordTabPanel baseId={panelBaseId} id="homework" activeId={tab}>
              ...
              <RecordTabPanel baseId={panelBaseId} id="videos" activeId={tab}>
