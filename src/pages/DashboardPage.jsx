...
// A notification's row marker, deliberately NOT RowIcon.
//
  ...
  return (
    <ul className="flex flex-col">
      {notifications.map((notification) => (
        <li
          key={notification.id}
          className="flex items-start justify-between gap-3 border-b border-border py-3 pl-3 last:border-b-0 last:pb-0 border-l-2 border-l-primary/40"
        >
