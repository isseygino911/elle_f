  ...
  "group/alert relative grid w-full gap-0.5 rounded-md border px-2.5 py-2 text-left text-sm has-data-[slot=alert-action]:relative has-data-[slot=alert-action]:pr-18 has-[>svg]:grid-cols-[auto_1fr] has-[>svg]:gap-x-2 *:[svg]:row-span-2 *:[svg]:translate-y-0.5 *:[svg]:text-current *:[svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        destructive:
          "bg-danger-bg text-danger-text border-danger-border *:data-[slot=alert-description]:text-danger-text/90 *:[svg]:text-current",
        success:
          "bg-success-bg text-success-text border-success-border *:data-[slot=alert-description]:text-success-text/90 *:[svg]:text-current",
      },
    },
    defaultVariants: {
      variant: "default",
